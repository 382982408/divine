...
- `divine.xls`
	...
	This is an excel table by generated by Varant. Divine annotates a ranking score per gene so that you can sort the variant list by the ranking score ('Comments_on_Genes' at column 'AJ' in the 2nd tab, VCF).
